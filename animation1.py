...
if __name__ == "__main__":
    ...
    # manim -pqh animation1.py Scene1_Introduction Scene2_PersonalityDistributions Scene3_LearningEffects Scene4_RegressionModels Scene5_PowerAnalysis Scene6_TraitDependence Scene7_Conclusion
    pass
